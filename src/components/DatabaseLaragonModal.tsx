...
export const DatabaseLaragonModal: React.FC<DatabaseLaragonModalProps> = ({
  ...
  const handleCopySql = () => {
    ...
    setCopiedSql(true);
    onSuccessToast(
      "SQL Berhasil Disalin",
      "Skrip SQL Laragon disalin ke clipboard.",
    );
  ...
  const handleDownloadSql = () => {
    ...
    onSuccessToast(
      "File SQL Diunduh",
      "sim_sop_gtk_laragon.sql siap diimpor ke HeidiSQL / phpMyAdmin Laragon.",
    );
  };
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Penyimpanan Data Login, Naskah POS AP, dan Catatan Riwayat
                Perubahan
              </p>
            </div>
          </div>
            ...
            <div className="space-y-5">
              ...
              >
                ...
                <div className="flex items-center space-x-2 self-end sm:self-center">
                  ...
                  >
                    <RefreshCw
                      className={`w-3.5 h-3.5 ${testingConnection ? "animate-spin text-blue-600" : ""}`}
                    />
                    <span>
            ...
            <div className="space-y-4">
              <div className="bg-blue-50/70 border border-blue-200 rounded-xl p-3 text-xs text-blue-900">
                <p className="font-semibold">
                  Skema Basis Data MySQL Laragon (
                  <code className="font-mono">sim_sop_gtk</code>)
                </p>
                <p className="text-[11px] text-blue-800 mt-0.5">
                  Dikelola dan diakses sepenuhnya melalui framework JavaScript
                  Express.js (Node.js) tanpa ketergantungan PHP.
                </p>
              </div>
                ...
                <div className="bg-slate-800 text-white px-4 py-2.5 flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-[11px] text-slate-400">
                      (Kredensial Login & Akun Pengguna)
                    </span>
                  </div>
                </div>
                  ...
                  <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-slate-100 text-slate-700">
                      ...
                      <tr>
                        ...
                        <td className="px-3 py-1.5 font-mono">
                          VARCHAR(191) UNIQUE NOT NULL
                        </td>
                        <td className="px-3 py-1.5">
                          Alamat email resmi GTK (kredensial login)
                        </td>
                      </tr>
                      <tr>
                        <td className="px-3 py-1.5 font-mono text-blue-700">
                      ...
                      <tr>
                        ...
                        <td className="px-3 py-1.5">
                          Nama lengkap beserta gelar kedinasan
                        </td>
                      </tr>
                      <tr>
                        <td className="px-3 py-1.5 font-mono text-blue-700">
                        ...
                        <td className="px-3 py-1.5">
                          Nomor Induk Pegawai (NIP 18 Digit)
                        </td>
                      </tr>
                      <tr>
                        <td className="px-3 py-1.5 font-mono text-blue-700">
                        ...
                        <td className="px-3 py-1.5">
                          Jabatan / Peran hak akses SIM-SOP
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-xs">
                <div className="bg-slate-800 text-white px-4 py-2.5 flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-mono font-bold text-xs">
                      Tabel 2: sop_documents
                    </span>
                    <span className="text-[11px] text-slate-400">
                      (Naskah Resmi POS AP Format KemenPAN-RB No. 35/2012)
                    </span>
                  </div>
                </div>
                <div className="overflow-x-auto text-xs">
                  <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-slate-100 text-slate-700">
                      ...
                      <tr>
                        ...
                        <td className="px-3 py-1.5">
                          Nomor Surat Keputusan POS AP resmi
                        </td>
                      </tr>
                      <tr>
                        <td className="px-3 py-1.5 font-mono text-blue-700">
                      ...
                      <tr>
                        ...
                        <td className="px-3 py-1.5">
                          Kementerian dan unit kerja GTK Gorontalo
                        </td>
                      </tr>
                      <tr>
                        <td className="px-3 py-1.5 font-mono text-blue-700">
                          disahkan_nama, disahkan_nip, disahkan_jabatan
                        </td>
                        <td className="px-3 py-1.5 font-mono">VARCHAR(255)</td>
                        <td className="px-3 py-1.5">
                          Pejabat berwenang yang mengesahkan
                        </td>
                      </tr>
                      <tr>
                        <td className="px-3 py-1.5 font-mono text-blue-700">
                          dasar_hukum, kualifikasi_pelaksana, peralatan, dll
                        </td>
                        <td className="px-3 py-1.5 font-mono">JSON NOT NULL</td>
                        <td className="px-3 py-1.5">
                          Array butir-butir standar naskah dinas
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-xs">
                <div className="bg-slate-800 text-white px-4 py-2.5 flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-mono font-bold text-xs">
                      Tabel 3: data_changes
                    </span>
                    <span className="text-[11px] text-slate-400">
                      (Audit Log Perubahan Data dalam Program)
                    </span>
                  </div>
                </div>
                <div className="overflow-x-auto text-xs">
                  <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-slate-100 text-slate-700">
                      ...
                      <tr>
                        ...
                        <td className="px-3 py-1.5">
                          Objek: 'AUTH', 'SOP_DOCUMENT', 'USER_ACCOUNT'
                        </td>
                      </tr>
                      <tr>
                        <td className="px-3 py-1.5 font-mono text-blue-700">
                        ...
                        <td className="px-3 py-1.5 font-mono">VARCHAR(50)</td>
                        <td className="px-3 py-1.5">
                          Aksi: 'CREATE', 'UPDATE', 'DELETE', 'LOGIN_SUCCESS'
                        </td>
                      </tr>
                      <tr>
                        <td className="px-3 py-1.5 font-mono text-blue-700">
                        ...
                        <td className="px-3 py-1.5">
                          Operator yang melakukan perubahan data
                        </td>
                      </tr>
                      <tr>
                        <td className="px-3 py-1.5 font-mono text-blue-700">
              ...
              <div className="flex items-center justify-between text-xs text-slate-600 bg-white p-3 rounded-xl border border-slate-200">
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">
                    Setiap penambahan, pengeditan, atau penghapusan naskah dan
                    akun disimpan ke tabel{" "}
            ...
            <div className="space-y-4 text-xs text-slate-700">
              <div className="bg-slate-900 text-white p-4 rounded-xl space-y-2">
                <div className="flex items-center space-x-2 text-amber-400 font-bold text-sm">
                  <Terminal className="w-4 h-4" />
                  <span>
                    Langkah Cepat Menghubungkan ke Laragon di PC Lokal
                  </span>
                </div>
                <p className="text-slate-300 text-xs">
                  Aplikasi ini menggunakan backend{" "}
                  <strong className="text-white">
                    JavaScript / Express.js
                  </strong>{" "}
                  dan tidak memerlukan PHP sama sekali. Ikuti langkah di bawah
                  ini untuk koneksi langsung ke MySQL Laragon:
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs space-y-2">
                  ...
                  <p className="text-slate-600 text-xs">
                    Buka aplikasi <strong>Laragon</strong> di komputer Anda,
                    lalu klik tombol <strong>"Start All"</strong> (pastikan
                    modul MySQL aktif pada port default 3306).
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <h5 className="font-bold text-slate-900">
                      Impor Database sim_sop_gtk
                    </h5>
                  </div>
                  <p className="text-slate-600 text-xs">
                    Klik tombol <strong>"Database" (HeidiSQL)</strong> di
                    Laragon, lalu buka file{" "}
                    <code className="bg-slate-100 px-1 py-0.5 rounded font-mono text-blue-600">
                      sim_sop_gtk_laragon.sql
                    </code>{" "}
                    atau jalankan skrip SQL yang telah disediakan.
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs space-y-2">
                  ...
                  <p className="text-slate-600 text-xs">
                    ...
                    Backend Express akan otomatis menghubungkan port 3000 ke
                ...
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs space-y-2">
                  ...
                  <p className="text-slate-600 text-xs">
                    Setiap penambahan naskah POS AP, edit naskah, ganti kata
                    sandi, maupun akun login baru langsung tercatat secara
                    permanen di tabel MySQL Laragon.
                  </p>
                </div>
              </div>
